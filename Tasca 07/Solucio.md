# T07 — Accés remot  
## Serveis d’assistència remota amb TeamViewer (Tasca en parelles)
...
1. L’usuari facilita el seu **ID** al tècnic.
2. El tècnic introdueix l’ID a TeamViewer.
3. L’usuari comunica la **contrasenya temporal**.
4. El tècnic accedeix a la sessió.

✔️ Mètode ràpid  
✔️ Molt utilitzat en assistència tècnica
...
2. L’usuari introdueix el codi a TeamViewer.
3. L’usuari accepta la connexió.
4. El tècnic accedeix a la sessió.

✔️ Mètode segur  
✔️ Ideal per connexions puntuals
...
TeamViewer és una eina essencial en entorns professionals perquè:
- Facilita l’assistència remota
- Redueix temps de resolució d’incidències
- Permet una gestió segura i controlada
- Simula situacions reals de suport IT
